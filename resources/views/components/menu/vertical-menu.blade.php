            ...
            @can('view-rowdata')
                ...
                <li class="menu {{ Request::is('*/data/row-data/*') ? 'active' : '' }}">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('*/data/row-data/*') ? 'show' : '' }}"
                        ...
                        <li class="{{ Request::routeIs('row-data-quality-defect') ? 'active' : '' }}">
                            <a href="{{ route('row-data-quality-defect') }}"> 品保食安 </a>
                        </li>
                        <li class="{{ Request::routeIs('row-data-quality-clear-defect') ? 'active' : '' }}">
                            <a href="{{ route('row-data-quality-clear-defect') }}"> 品保清檢 </a>
                        </li>
                    </ul>
                </li>
            @endcan
