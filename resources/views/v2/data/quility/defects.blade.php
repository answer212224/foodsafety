                            ...
                            <v-row align="center" class="pa-2">
                                ...
                                <v-col cols="12" sm="6">
                                    <v-text-field v-model="search" append-icon="mdi-magnify"
                                        label="啟動月份、分類、子項目、類別、扣分、稽核標準、報告呈現說明" single-line>
                                </v-col>
                            </v-row>
                        </template>
                ...
                methods: {
                    ...
                    save() {
                        if (this.editedIndex > -1) {
                            axios.put('/api/quality-defects/' + this.editedItem.id, this.editedItem)
                                .then(response => {
                                    this.getDefects();
                                })
                                .catch(error => {
                            ...
                            axios.post('/api/quality-defects', this.editedItem)
                                .then(response => {
                                    this.getDefects();
                                })
                                .catch(error => {
                    ...
                    deleteItem(item) {
                        ...
                        this.loading = true;
                        axios.delete('/api/quality-defects/' + item.id)
                            .then(response => {
                                this.getDefects();
                            })
                            .catch(error => {
                    ...
                    importData() {
                        ...
                        this.loading = true;
                        axios.post('/api/quality-defects/import', formData, {
                                headers: {
