            ...
            <v-main class="grey lighten-4">
                <v-container>
                    ...
                    <v-data-table :headers="headers" :items="restaurants" :search="search" item-key="id"
                        class="elevation-1 my-table" :loading="loading" sort-by="status" sort-desc fixed-header
                        height="calc(100vh - 300px)">
                        <template v-slot:top>
                            <v-row align="center"class="pa-2">
                                <v-col cols="12" sm="6">
                                    <v-icon>mdi-information</v-icon> <span>只能新增央廚資料</span>
                                </v-col>
                                <v-col cols="12" sm="6">
                                    <v-text-field v-model="search" append-icon="mdi-magnify" label="品牌代碼、品牌店代碼、品牌、店別、區域"
                ...
                <v-dialog v-model="editDialog" max-width="600px"
                    @click:outside="editDialog = false;editedItem = {sort: 99, area: '', status: true}">
                    <v-card>
                        <v-card-title>
                        ...
                        <v-card-actions>
                            ...
                            <v-btn color="blue darken-1" text @click="save"
                                v-if="editedItem.area && editedItem.sort">儲存</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-dialog>
