                            ...
                            <v-row align="center" class="pa-2">
                                <v-col cols="12" sm="6">
                                    ...
                                    <v-menu ref="menu" v-model="menu" transition="scale-transition" offset-y
                                        ...
                                        <template v-slot:activator="{ on }">
                                            <v-text-field v-model="month" label="啟動月份" prepend-icon="mdi-calendar"
                                                readonly v-on="on" clearable></v-text-field>
                                        </template>
                                        <v-date-picker v-model="month" no-title scrollable type="month" locale="zh-TW"
                                            locale="zh-TW">
                                        </v-date-picker>
                                    </v-menu>
                                ...
                                <v-col cols="12" sm="6">
                                    <v-text-field v-model="search" append-icon="mdi-magnify"
                                        label="啟動月份、分類、子項目、類別、扣分、稽核標準、報告呈現說明" single-line></v-text-field>
                                </v-col>
                            </v-row>
                        </template>
                        ...
                        <v-card-text>
                            <v-container>
                                <v-form v-model="valid">
                                    <v-row>
                                        <v-col cols="12" sm="6">
                                            <v-menu ref="menu" v-model="menu1" transition="scale-transition" offset-y
                                                max-width="290px" min-width="290px">
                                                <template v-slot:activator="{ on }">
                ...
                <v-dialog v-model="importDialog" max-width="500px">
                    <v-card>
                        <v-card-title>
                            ...
                            <v-spacer></v-spacer>
                            <a href="{{ asset('storage/defects_import.xlsx') }}" download>範例下載</a>
                        </v-card-title>
