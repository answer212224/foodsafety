            ...
            <v-main class="grey lighten-4">
                <v-container>
                    ...
                    <v-data-table :headers="headers" :items="users" :search="search" item-key="id"
                        class="elevation-1 my-table" :loading="loading" sort-by="status" fixed-header
                        height="calc(100vh - 300px)">
                        <template v-slot:top>
                            <v-row align="center" class="pa-2">
                                <v-col cols="12" sm="6">
                                    <v-icon>mdi-information</v-icon> <span>只能更新角色</span>
                                </v-col>
                                <v-col cols="12" sm="6">
                                    <v-text-field v-model="search" append-icon="mdi-magnify" label="員編、姓名、Email、部門"
