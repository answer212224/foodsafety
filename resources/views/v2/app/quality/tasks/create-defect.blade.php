                ...
                <v-container>
                    ...
                    <v-row class="d-flex justify-space-between align-center">
                        ...
                        <v-col cols="6" class="text-right">
                            ...
                            <v-btn color="primary" text
                                href="{{ route('v2.app.quality-tasks.defect.edit', $task->id) }}">
                                稽核紀錄
                    ...
                    <v-row>
                        <v-col cols="12">
                            ...
                            <form action="{{ route('task-quality-defect-store', $task->id) }}" method="POST">
                                @csrf
                                        ...
                                        <v-stepper-content step="1">
                                            <v-card>
                                                ...
                                                <v-card-text>
                                                    <v-row>
                                                        <v-col cols="12" sm="12">
                                                            <input type="file" name="filepond[]" multiple capture="environment">
                                                        </v-col>
                                                    </v-row>
                                                </v-card-text>
                                                <v-divider></v-divider>
        ...
        <script>
            new Vue({
                ...
                methods: {
                    ...
                    getTask() {
                        this.loading = true;
                        axios.get(`/api/quality-tasks/{{ $task->id }}`)
                            .then((res) => {
                    ...
                    getActiveDefects() {
                        this.loading = true;
                        axios.get(`/api/quality-defects/active`)
                            .then((res) => {
