                    ...
                    <v-row class="d-flex justify-space-between align-center">
                        ...
                        <v-col cols="6" class="text-right">
                            ...
                            <v-btn color="primary" text
                                href="{{ route('v2.app.quality-tasks.defect.create', $task->id) }}">
                                新增缺失
                                            ...
                                            <v-card class="my-3">
                                                ...
                                                <v-card-text>
                                                    <v-row>
                                                        ...
                                                        <v-col cols="12">
                                                            <v-text-field label="缺失分類"
                                                                v-model="taskDefect.defect.group"
                                                                readonly></v-text-field>
                                                        </v-col>
                                                        <v-col cols="12">
                                                            <v-text-field label="子項目"
                                                                v-model="taskDefect.defect.title"
                                                                readonly></v-text-field>
                                                        </v-col>
                                                        <v-col cols="12">
                    ...
                    <v-card>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols="12">
                                        <v-select
                                            ...
                                            v-model="editedItem.quality_defect_id">
                        ...
                        <v-card-actions>
                            ...
                            <v-btn color="blue darken-1" text @click="save"
                                :disabled="!editedItem.quality_defect_id">
                                儲存
                            </v-btn>
                        </v-card-actions>
                    </v-card>
        ...
        <script>
            new Vue({
                ...
                methods: {
                    getDefects() {
                        this.loading = true;
                        axios.get(`/api/quality-tasks/{{ $task->id }}/defects`).then((res) => {
                    ...
                    getActiveDefects() {
                        this.loading = true;
                        axios.get(`/api/quality-defects/active`).then((res) => {
                    ...
                    getTaskScore() {
                        loading = true;
                        axios.get(`/api/quality-tasks/{{ $task->id }}/defect/score`).then((res) => {
                    ...
                    save() {
                        this.dialog = false;
                        this.loading = true;
                        axios.put(`/api/quality-tasks/defects/${this.editedItem.id}`, {
                            restaurant_workspace_id: this.editedItem.restaurant_workspace_id,
                            quality_defect_id: this.editedItem.quality_defect_id,
                    ...
                    deleteItem(taskDefect) {
                        ...
                        this.loading = true;
                        axios.delete(`/api/quality-tasks/defects/${taskDefect.id}`).then((res) => {
                                if (res.data.status == 'success') {
                                    this.getDefects();
                                    this.getTaskScore();
                                    alert('刪除成功');
