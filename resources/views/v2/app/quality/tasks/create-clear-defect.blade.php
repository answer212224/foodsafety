                ...
                <v-container>
                    ...
                    <v-row class="d-flex justify-space-between align-center">
                        ...
                        <v-col cols="6" class="text-right">
                            ...
                            <v-btn color="primary" text
                                href="{{ route('v2.app.quality-tasks.clear-defect.edit', $task->id) }}">
                                稽核紀錄
                    ...
                    <v-row>
                        <v-col cols="12">
                            ...
                            <form action="{{ route('task-quality-clear-defect-store', $task->id) }}" method="POST">
                                @csrf
                                            ...
                                            <v-card>
                                                ...
                                                <v-card-text>
                                                    <v-row>
                                                        ...
                                                        {{-- 重複缺失 --}}
                                                        <v-col cols="6">
                                                            <v-checkbox label="重複缺失" name="is_repeat"
                                                                value="1" color="red darken-3"></v-checkbox>
                                                        </v-col>
                                                        <v-col cols="12">
        ...
        <script>
            new Vue({
                ...
                methods: {
                    ...
                    getTask() {
                        this.loading = true;
                        axios.get(`/api/quality-tasks/{{ $task->id }}`).then((res) => {
                    ...
                    getActiveClearDefects() {
                        this.loading = true;
                        axios.get(`/api/quality-clear-defects/active`).then((res) => {
