                                ...
                                <v-card-text>
                                    ...
                                    <v-row>
                                        <div class="subtitle-2 col-12 col-sm-6">
                                            {{-- google map --}}
                                            <a :href="`https://www.google.com/maps/search/?api=1&query=${task.restaurant.brand},${task.restaurant.shop}`"
                                                target="_blank">
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        <v-col cols="12" sm="12">
                                            <v-text-field label="內場主管" v-model.lazy="taskItem.inner_manager"
                                                prepend-icon="mdi-account-tie">
                                            </v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="12">
                                            <v-text-field label="外場主管" v-model.lazy="taskItem.outer_manager"
                                                prepend-icon="mdi-account-tie">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
